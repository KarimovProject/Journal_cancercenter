...
## Loyiha holati — ENG BIRINCHI O'QING

**Har bir sessiyada, birinchi ishdan oldin `GOALS.md` ni o'qing.** Unda loyiha
nima ekani, nimalar bajarilgani, hozir qaysi bosqichda ekani, keyin nima
qilinishi kerakligi va vaqt yo'qotishga sabab bo'ladigan tuzoqlar yozilgan.

Ish tugagach `GOALS.md` ni yangilang — bajarilgan ishni sana bilan qo'shing,
hal bo'lgan muammoni o'chiring, yangi topilgan tuzoqni yozing. Bu fayl loyihaning
yagona holat manbai; `PROJECT_TRACKER.md` eskirgan (tarixiy).
