...
class Article(TimeStampedModel):
    ...
    def citation_apa(self):
        from .utils.citations import generate_citation_apa
        return generate_citation_apa(self)

    def citation_mla(self):
        from .utils.citations import generate_citation_mla
        return generate_citation_mla(self)

    def citation_harvard(self):
        from .utils.citations import generate_citation_harvard
        return generate_citation_harvard(self)

    def citation_vancouver(self):
        from .utils.citations import generate_citation_vancouver
        return generate_citation_vancouver(self)

    def citation_ris(self):
        from .utils.citations import generate_citation_ris
        return generate_citation_ris(self)
...
class Review(TimeStampedModel):
    ...
    reviewer = models.ForeignKey('auth.User', related_name='assigned_reviews', on_delete=models.SET_NULL, null=True, verbose_name=_('Taqrizchi'))
