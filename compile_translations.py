...
RU = {
    ...
    "Adabiyotlar ro'yxati": "Список литературы",
    "Etika va moliyalashtirish": "Этика и финансирование",
    "Adabiyot qo'shish": "Добавить источник",
    "Rasm qo'shish": "Добавить рисунок",
    "Fayl qo'shish": "Добавить файл",
    "O'chirish": "Удалить",
    "Maqolaning to'liq matnini shu yerga kiriting. Kamida o'zbek tilida tavsiya etiladi.": "Введите полный текст статьи здесь. Рекомендуется хотя бы на узбекском языке.",
...
EN = {
    ...
    "Etika va moliyalashtirish": "Ethics and funding",
    "Adabiyot qo'shish": "Add reference",
    "Rasm qo'shish": "Add figure",
    "Fayl qo'shish": "Add file",
    "O'chirish": "Delete",
    "Maqolaning to'liq matnini shu yerga kiriting. Kamida o'zbek tilida tavsiya etiladi.": "Enter the full text of the article here. At least in Uzbek is recommended.",
